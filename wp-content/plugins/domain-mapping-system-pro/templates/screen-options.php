    ...
    <div id="screen-options-wrap" class="" tabindex="-1" aria-label="Screen Options Tab">
        <form id="adv-settings" method="post" action="<?= admin_url( 'admin-post.php' ); ?>">
            <fieldset class="screen-options">
                <legend><?php echo __( 'Pagination', $instance->plugin_name ) ?></legend>
                <label for="edit_mappings_per_page"><?php echo __( 'Number of mappings per page:', $instance->plugin_name ) ?></label>
                ...
                <br/><br/>
                <label for="edit_values_per_mapping"><?php echo __( 'Number of values per mapping:', $instance->plugin_name ) ?></label>
...
<div id="screen-meta-links">
    <div id="screen-options-link-wrap" class="hide-if-no-js screen-meta-toggle">
        <button type="button" id="show-settings-link" class="button show-settings" aria-controls="screen-options-wrap"
                aria-expanded="true"><?php echo __( 'Screen Options', $instance->plugin_name ) ?></button>
    </div>
</div>