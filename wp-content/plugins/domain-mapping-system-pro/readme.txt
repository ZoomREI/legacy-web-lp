...
Tags: multiple domains, multidomain, multisite, subdomain, alias, microsites, domain mapping, multidomain, redirect, subsites, mapping, domains, seo, marketing, mirror, redirect, cPanel, WPML, networks, DNS, cross domain tracking, google analytics, woocommerce, yoast seo, hostname, http, url, theme per domain, domain per category, archive mapping, custom taxonomy per domain, favicon per domain
...
Domain Mapping System is the most powerful way to manage multiple alias domains on your WordPress site and map them to any published resource - creating Microsites with ease!
...
Whether you’re just looking for the simplicity of multiple domain mapping in a single WordPress site, or you’re creating a more complex multi-pronged WordPress project, [Domain Mapping System](https://domainmappingsystem.com?utm_source=wporg&utm_medium=readme&utm_campaign=dms) can save a great deal of time and hassle over using multisite or creating standalone WordPress installs. 
...
🎬 [TRY THE LIVE DEMO >](https://domain-mapping-system-demo.xyz/)

🌱 [PLANS & PRICING >](https://domainmappingsystem.com/?utm_source=wporg&utm_medium=readme&utm_campaign=dms#pricing)

🚧 [ROADMAP >](https://domainmappingsystem.com/roadmap/?utm_source=wporg&utm_medium=readme&utm_campaign=dms)
...
## 🔀 SUBDOMAIN MAPPING 
> Map subdomains to your primary WordPress site, so you don’t have to create a second WordPress install or buy a second domain.
...
* Map subdomains 
* Multisite supported (requires custom sunrise.php, please see our [documentation](https://docs.domainmappingsystem.com/features/multisite-integration).

## PRO FEATURES
* Create “Microsites” - set a different homepage and inner pages for each domain
...
**[Unlimited Domain Mapping](https://docs.domainmappingsystem.com/features/domain-mapping)**: Expand your online presence without limitations, enabling you to manage multiple domains effortlessly from a single WordPress Dashboard. 

**[Flexible Mapping Options](https://docs.domainmappingsystem.com/features/global-archive-category-mapping)**: Seamlessly map domains to various types of content, including posts, pages, products, custom post types, and more, enhancing your site's organizational structure and user experience.

**[Subdomain Mapping](https://docs.domainmappingsystem.com/features/mapping-with-subdomains)**: Easily extend your site's reach by mapping subdomains, enabling you to efficiently manage diverse content.

**[Multisite Compatibility](https://docs.domainmappingsystem.com/features/multisite-integration)**: Harness the power of WordPress Multisite while effortlessly integrating with the Domain Mapping System, streamlining management of multiple domains across multiple network sites.

**[Microsite Creation](https://docs.domainmappingsystem.com/features/creating-microsites-multisite-alternative)**: Tailor each domain with unique homepages and inner pages, empowering you to create distinct online experiences catered to specific audiences or purposes.

**[Automatic Global Domain Mapping](https://docs.domainmappingsystem.com/features/global-domain-mapping)**: Simplify domain management by automatically mapping all published content, ensuring consistency and coherence across your entire site.

**[Subdirectory Mapping](https://docs.domainmappingsystem.com/features/subdirectory-mapping)**: Organize your site structure effectively by mapping domains to specific subdirectories, facilitating intuitive navigation and content discovery.

**[Visitor Redirection](https://docs.domainmappingsystem.com/features/redirect-site-visitors-to-mapped-domains)**: Enhance user experience and maintain brand consistency by seamlessly redirecting visitors to the proper mapped domain based on the domain being viewed.

**[Customized Favicon Support](https://docs.domainmappingsystem.com/features/favicon-per-domain)**: Reinforce your brand identity across multiple domains with custom favicons, enhancing recognition and user engagement.

**[WooCommerce Integration](https://docs.domainmappingsystem.com/features/global-product-mapping-for-woocommerce)**: Seamlessly integrate with WooCommerce, optimizing the shopping experience by mapping essential pages such as Shop, Checkout, and Cart across domains.

**[Query String Support](https://docs.domainmappingsystem.com/features/query-string-parameters)**: Maximize marketing effectiveness by preserving UTM parameters on mapped domains, enabling accurate tracking and analysis of user interactions.

**[Global Parent Page Mapping](https://docs.domainmappingsystem.com/features/global-parent-page-mapping)**: Ensure consistency in site structure and navigation by globally mapping parent pages across domains, simplifying content organization.

**[URL Rewriting Flexibility](https://docs.domainmappingsystem.com/features/url-rewriting)**: Tailor URL structures to meet specific requirements or preferences, enhancing SEO optimization and user-friendly navigation.

**[Yoast SEO Integration](https://docs.domainmappingsystem.com/integrations-and-compatibility/wordpress-plugins/yoast-seo)**: Augment your site's search engine visibility and performance with seamless integration with Yoast SEO, enabling comprehensive optimization across mapped domains.
...
1. Search for ‘Domain Mapping System’;
...
1. Activate the Domain Mapping System plugin through the ‘Plugins’ menu in WordPress;
1. Go to ‘after activation’ below.

### AFTER ACTIVATION

1. You should be redirected to the settings area. 
1. Add your alias domain and the published resource you want to use to display content for the alias domain. 
1. Visit your alias domain!
1. Be sure to visit our [Troubleshooting Guide](https://docs.domainmappingsystem.com/getting-started/troubleshooting) for any issues. 
...
Yes! Domain mapping is free in WordPress. You can map unlimited domains to your WordPress website depending on your server configuration. To create Microsites with Domain Mapping System and access other powerful features, please see our [pricing](https://domainmappingsystem.com/?utm_source=wporg&utm_medium=readme&utm_campaign=dms#pricing). 
...
Please see our [Documentation](https://docs.domainmappingsystem.com/faqs/what-hosting-companies-are-supported) for a list of hosting companies we’ve found that are compatible with domain mapping and Alias Domains. 
...
Please [contact support](https://domainmappingsystem.com/support/?utm_source=wporg&utm_medium=readme&utm_campaign=dms) to report the bug with any relevant screenshots/videos/notes.
...
Yes. You have complete control over your data. [Contact us](https://domainmappingsystem.com/support/?utm_source=wporg&utm_medium=readme&utm_campaign=dms) any time to remove your data or choose NOT to opt-in upon activating the plugin. If you choose to opt-in so we can improve our product, we use Freemius to store user data, which is [GDPR ready](https://freemius.com/blog/gdpr-wordpress-plugin-theme/). 

= I'm a developer and want to contribute to Domain Mapping System. Where can I do it? =

We really appreciate your input! We currently don't have a public repo, but you can [contact us](https://domainmappingsystem.com/support/?utm_source=wporg&utm_medium=readme&utm_campaign=dms) directly with any feature/code suggestions, and we can give you a branch to work on or integrate your suggestions into a future release 😊  

== Screenshots ==

1. Domain Mapping System Settings Area
2. Adding Multiple Domains to WordPress
3. Creating a Microsite (PRO) - Multisite Alternative / Supplement 
