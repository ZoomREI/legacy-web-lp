...
/*!********************************************!*\
  !*** ./src/ao-as-seen-on-carousel/view.js ***!
  \********************************************/
__webpack_require__.r(__webpack_exports__);
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function cloneLogos() {
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(logos, {
      width: `${logosWidth * 2}px`
    });
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(logos, {
      x: `-${logosWidth}px`,
      duration: 20,
      ease: "none",
      repeat: -1,
      modifiers: {
        x: gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.unitize(x => parseFloat(x) % logosWidth)
      }
    });
  }
  function checkScreenSize() {
    if (window.innerWidth < 1024 && !logos.classList.contains("animated")) {
      ...
      const clones = logos.querySelectorAll(".cloned");
      clones.forEach(clone => clone.remove());
      gsap__WEBPACK_IMPORTED_MODULE_0__["default"].killTweensOf(logos);
      gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(logos, {
        clearProps: "all"
      });
