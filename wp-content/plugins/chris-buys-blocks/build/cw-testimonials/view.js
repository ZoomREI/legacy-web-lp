...
gsap__WEBPACK_IMPORTED_MODULE_0__["default"].registerPlugin(gsap_Draggable__WEBPACK_IMPORTED_MODULE_1__.Draggable);
document.addEventListener("DOMContentLoaded", function () {
  ...
  var progressWrap = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.wrap(0, 1);
  var numSlides = slides.length;
  gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(slides, {
    xPercent: i => i * 100
  });
  var wrapX = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.wrap(-100, (numSlides - 1) * 100);
  var timer = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].delayedCall(slideDelay, autoPlay);
  var animation = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(slides, {
  ...
  var slideAnimation = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to({}, {});
  var slideWidth = 0;
  var wrapWidth = 0;
  var draggable = new gsap_Draggable__WEBPACK_IMPORTED_MODULE_1__.Draggable(proxy, {
  ...
  function animateSlides(direction) {
    timer.restart(true);
    slideAnimation.kill();
    var x = snapX(gsap__WEBPACK_IMPORTED_MODULE_0__["default"].getProperty(proxy, "x") + direction * slideWidth);
    slideAnimation = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].to(proxy, {
      x: x,
  ...
  function updateProgress() {
    animation.progress(progressWrap(gsap__WEBPACK_IMPORTED_MODULE_0__["default"].getProperty(proxy, "x") / wrapWidth));
    // //////////////////////////////////////////////////////////////////////////
    let prog = Math.abs(gsap__WEBPACK_IMPORTED_MODULE_0__["default"].getProperty(proxy, "x"));
    if (prog > maxWidth) {
      prevMW = maxWidth;
      maxWidth += wrapWidth;
    }
  ...
  function snapX(value) {
    let snapped = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.snap(slideWidth, value);
    return wrap ? snapped : gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.clamp(-slideWidth * (numSlides - 1), 0, snapped);
  }
  function resize() {
    var norm = gsap__WEBPACK_IMPORTED_MODULE_0__["default"].getProperty(proxy, "x") / wrapWidth || 0;
    ...
    gsap__WEBPACK_IMPORTED_MODULE_0__["default"].set(proxy, {
      x: norm * wrapWidth
    });
    animateSlides(0);
