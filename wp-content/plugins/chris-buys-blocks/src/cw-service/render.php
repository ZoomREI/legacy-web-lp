<?php
$logoUrl = plugins_url('src/cw-service/assets/icon-logo.svg', dirname(__FILE__, 2));
    ...
    <div class="cw-service__table">
        <div class="cw-service__row cw-service__row--header">
            ...
            <div class="cw-service__row--centr-item">
                <img  src="<?php echo $logoUrl; ?>" alt="logo" class="cw-service__row--icon">
                <div class="cw-service__row--text">Selling with Chris Buys Homes</div>
            </div>
