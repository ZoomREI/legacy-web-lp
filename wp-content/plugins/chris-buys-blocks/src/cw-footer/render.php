<?php
$logos = [
    "Kansas City" => plugins_url('src/footer/assets/kc-footer-logo.svg', dirname(__FILE__, 2)),
    "San Francisco Bay Area" => plugins_url('src/footer/assets/sf-footer-logo.svg', dirname(__FILE__, 2)),
    "St. Louis" => plugins_url('src/footer/assets/stl-footer-logo.svg', dirname(__FILE__, 2)),
    "Metro Detroit" => plugins_url('src/footer/assets/det-footer-logo.svg', dirname(__FILE__, 2)),
    "Cleveland" => plugins_url('src/footer/assets/cle-footer-logo.svg', dirname(__FILE__, 2)),
    "Indianapolis" => plugins_url('src/footer/assets/ind-footer-logo.svg', dirname(__FILE__, 2)),
];
