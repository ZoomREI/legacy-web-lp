...
$lc_property_management_img_url = plugins_url('src/ao-property-management/assets/lc-cta-img.webp', dirname(__FILE__, 2));

$testimonee_url = plugins_url('src/ao-fresh-start/assets/testimonee.webp', dirname(__FILE__, 2));

$star_icon_url = plugins_url('src/ao-property-management/assets/star.svg', dirname(__FILE__, 2));
$arrow_icon_url = plugins_url('src/ao-property-management/assets/cta-arrow.svg', dirname(__FILE__, 2));
$circle_icon_url = plugins_url('src/ao-property-management/assets/icon-circle.svg', dirname(__FILE__, 2));
$verified_check_url = plugins_url('src/ao-property-management/assets/verified-check-circle.svg', dirname(__FILE__, 2));
?>
